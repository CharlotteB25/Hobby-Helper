export default {
  ...
  accentDark: "#52734D", // deeper green (hover/active states)
  highlight: "#FFD166", // fresh yellow (for playful touches, alerts, or icons)
  neutral: "#94A3B8", // muted gray for borders, placeholders
  white: "#FFFFFF",
};
